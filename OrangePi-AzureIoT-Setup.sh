...
cp ./Source/OrangePi/PortLib/OrangePi /usr/bin/
cp ./Source/OrangePi/Azure_IOTLib/OrangePi2Azure.h /usr/include/
cd ./Source/OrangePi/Azure_IOTLib
...
cd ./Source/OrangePi/OrangePiSpeech2Text
./setup.sh
...
cd ./Source/OrangePi/mjpg-streamer
./setup.sh
cd ..
...
# Build websit
gcc ./Source/OrangePi/Websit/cgi-bin/do_one_capture.c -o Websit/cgi-bin/do_one_capture.cgi
gcc ./Source/OrangePi/Websit/cgi-bin/update.c -o Websit/cgi-bin/update.cgi
cp -rf ./Source/OrangePi/Websit/html/* /var/www/html/
mkdir /var/www/cgi-bin
cp -rf ./Source/OrangePi/Websit/cgi-bin/* /var/www/cgi-bin/
cp -rf ./Source/OrangePi/Websit/apache2/* /etc/apache2/

# build Sample code
# Build the OrangePi to Azure API
gcc ./Source/OrangePi/Sample_OrangePi2Azure.c -lOrangePi2Azure -o ToAzure

# Build the OrangePi to get sound of API
gcc ./Source/OrangePi/Sample_OrangePi2Sound.c -lOrangePi2Sound -o ToSound

# Build the OrangePi to get video of API
gcc ./Source/OrangePi/Sample_OrangePi2video.c -lOrangePi2CognitiveService -o ToVideo
cp ./Source/OrangePi/ToVideo /var/www/cgi-bin/
